...
const loginUser = asyncHandler(async (req, res) => {
  ...
  // The options can't be changed in the browser, only in the server
  const options = {
    httpOnly: true,
    secure: true,
  };
...
// User Logout
// Remove refresh token from user and clear cookies
...
// Check if refresh token is valid and generate new access token
...
// Check if old password is correct and update the password
...
// Check if all fields are filled and update the user
...
// Update User Avatar
// Upload the avatar image to Cloudinary and update the user
...
// Upload the cover image to Cloudinary and update the user
